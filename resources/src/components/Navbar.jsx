...
import MainStateSearchBar, {
  ContextSearch,
} from "./MainStateSearchBar/MainStateSearchBar";
import LoginDialog from "./Login";
import Three_Btns from "./Three_Btns";
import SearchBar from "./SearchBar";

function Navbar({ slug }) {
  const { openedSearch, setopenedSearch } = useContext(ContextSearch);
      ...
      >
        ...
        >
          <h1 className="text-[32px] -text--brand-clr [&_span]:-text--primary-black leading-[25px] font-[500]">
            Book<span>any</span>.<span>pk</span>
          </h1>
          <h2 className="-text--primary-black text-[11px] leading-[14px] font-[400] pl-0.5">
            By Hokrex
          </h2>
        </Link>
